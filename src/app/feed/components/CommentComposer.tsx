...
export default function CommentComposer({
	...
	const submit = async () => {
		...
		if (!result.success) {
			setError(getFieldErrors(result.error).content ?? "");
			return;
		}
		...
		setError("");
		try {
			const comment = await api.post<Comment>(url, {
				...body,
		...
		<div className="_feed_inner_comment_box">
			...
			>
				<div className="_feed_inner_comment_box_content">
					...
					<div className="_feed_inner_comment_box_content_txt">
						<textarea
							...
							placeholder={loading ? "Posting..." : placeholder}
							value={content}
							disabled={loading}
				...
				<div className="_feed_inner_comment_box_icon">
					...
					<button
						type="submit"
						className="_previous_comment_txt _mar_l8"
