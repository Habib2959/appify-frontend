  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-light _header_nav _padd_t10">
      <div className="container _custom_container">
        ...
        <button className="navbar-toggler bg-light" type="button" onClick={() => setNavOpen((prev) => !prev)} aria-controls="navbarSupportedContent" aria-expanded={navOpen} aria-label="Toggle navigation"> <span className="navbar-toggler-icon"></span>
        </button>
        <div className={`collapse navbar-collapse${navOpen ? " show" : ""}`} id="navbarSupportedContent">
          ...
          <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
            ...
            <li className="nav-item _header_nav_item">
              <span id="_notify_btn" className="nav-link _header_nav_link _header_notify_btn" onClick={() => setNotifyOpen((prev) => !prev)}>
          ...
          <div className="_header_nav_profile">
            ...
            <div className="_header_nav_dropdown">
              ...
              <button id="_profile_drop_show_btn" className="_header_nav_dropdown_btn _dropdown_toggle" type="button" onClick={() => setProfileOpen((prev) => !prev)}>
